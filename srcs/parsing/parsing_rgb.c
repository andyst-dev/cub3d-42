...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/01/16 10:05:45 by ttreichl          #+#    #+#             */
/*   Updated: 2025/01/16 10:05:46 by ttreichl         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	check_rgb(t_game *game, int index, int i, int c_separate)
{
...
void	ft_find_rgb(t_game *game, int index, int i, int count_rgb)
{
	...
	while (game->map->dir[index][++i] != '\0')
	{
		...
		{
			c_separate = check_rgb(game, index, i, c_separate);
